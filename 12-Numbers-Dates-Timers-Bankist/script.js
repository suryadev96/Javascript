...
const formatMovementDate = function (date, locale) {
  //when performing subtraction; type casting happens to number. when date converts to number; it converts to milliseconds
...
const startLogOutTimer = function () {
  ...
  //for the first call, it should call immediately
  tick();
...
btnLoan.addEventListener('click', function (e) {
  ...
  if (amount > 0 && currentAccount.movements.some(mov => mov >= amount * 0.1)) {
    //Approving the loan after 2.5 seconds
    setTimeout(function () {
      // Add movement
      currentAccount.movements.push(amount);
...
console.log(23 === 23.0);
//Numbers are represented internally in 64 base 2 format
...
//precise calculations including time changes due to day light savings and other weird edge cases
...
//Registers this call back function
