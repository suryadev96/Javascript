...
const displayMovements = function (movements, sort = false) {
  ...
  `;
    ...
    //attach back html into the container
...
const checkDogs = function (dogsJulia, dogsKate) {
  ...
  dogsJuliaCorrected.splice(-2); //remove last two
  //dogsJulia.slice(1,3)
...
//Maximum value of movements arrat
...
console.log(arrDeep.flat()); //goes only 1 level deep
...
const movements = [200, 450, -400, 3000, -650, -130, 70, 1300];
//console.log(movements.sort()); //sort method works based on strings
...
//Array.from
//Array is a function and from is a method called on the function
