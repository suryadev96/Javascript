...
const loadImg = function (entries, observer) {
  ...
  //entry.target.classList.remove('lazy-img'); //see the effect on slow 3g
...
// Slider
//Lets put into same function so that we dont pollute gloabl namespace
